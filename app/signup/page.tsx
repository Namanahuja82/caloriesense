          ...
          <div className="mt-6">
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                className="inline-flex w-1/2 justify-center rounded-lg border border-gray-600 bg-gray-700 px-4 py-2 text-sm font-medium text-gray-300 shadow-sm transition-colors hover:bg-gray-600"
              >
              ...
              {/* Commented Google OAuth button for future implementation
    <button
