...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <nav className="bg-gray-900/95 shadow-xl p-4 fixed w-full z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <button 
              onClick={() => setChatOpen(!chatOpen)}
              className="flex items-center space-x-1 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg transition-colors duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
              </svg>
            ...
            <button 
              onClick={handleLogout}
              className="flex items-center space-x-1 bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
              </svg>
      ...
      {/* Main Content */}
      <div className="flex-1 pt-20 p-5 flex">
        {/* Upload/Analysis Section */}
        <div className={`flex flex-col items-center justify-center ${chatOpen ? 'w-1/2' : 'w-full'} transition-all duration-300`}>
          <div className="w-full max-w-md bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-8 space-y-6">
            <h1 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Calorie Analysis</h1>
            ...
            {activeTab === 'upload' && (
              <div className="space-y-4">
                <p className="text-center text-gray-300">Upload your restaurant bill to analyze calorie content</p>
                
                <div className="flex flex-col items-center justify-center w-full">
                  <label 
                    className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-600 rounded-lg cursor-pointer bg-gray-900 hover:bg-gray-800 transition-colors duration-200"
                  >
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <button
                  onClick={handleUpload}
                  disabled={!file || loading}
                  className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium rounded-lg shadow-md disabled:bg-gray-700 disabled:opacity-50 disabled:shadow-none transition-colors duration-200"
                >
                  {loading ? (
                    <div className="flex items-center justify-center">
                      <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {activeTab === 'manual' && (
              <div className="space-y-4">
                <p className="text-center text-gray-300">Enter your food items to calculate calories</p>
                ...
                <div className="space-y-3">
                    ...
                    <div key={index} className="flex space-x-2 items-center">
                      <div className="flex-1">
                        <input
                          ...
                          onChange={(e) => handleManualItemChange(index, 'name', e.target.value)}
                          placeholder="Food item (e.g., Chicken Caesar Salad)"
                          className="w-full px-3 py-2 border border-gray-600 rounded-md bg-gray-900 text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                        />
                      </div>
                      <div className="w-24">
                        <input
                      ...
                      <button
                        onClick={() => removeFoodItem(index)}
                        disabled={manualEntryItems.length <= 1}
                        className="p-2 text-gray-400 hover:text-red-400 transition-colors duration-200 disabled:text-gray-600"
                        title="Remove item"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                  ...
                  <button
                    onClick={addFoodItem}
                    className="w-full py-2 px-4 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded-md transition-colors duration-200 flex items-center justify-center"
                  >
                    <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
          ...
          {calorieData && (
            <div className="w-full max-w-md mt-6 bg-gray-800 border border-gray-700 rounded-xl shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4">
                <h2 className="text-xl font-bold">Calorie Breakdown</h2>
              </div>
              <div className="p-4">
                <div className="whitespace-pre-wrap font-mono text-sm bg-gray-900 p-4 rounded border border-gray-700 max-h-96 overflow-y-auto text-gray-300">
                  {calorieData}
                </div>
              </div>
            </div>
        ...
        {chatOpen && (
          <div className="w-1/2 h-[calc(100vh-5rem)] flex flex-col px-4">
            <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg flex-1 flex flex-col overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4">
                <h2 className="text-xl font-bold">Nutrition Chat Assistant</h2>
              </div>
              ...
              >
                {chatHistory.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {chatLoading && (
                      <div className="flex justify-start">
                        <div className="bg-gray-800 text-gray-200 rounded-lg rounded-bl-none px-4 py-2">
                          <div className="flex space-x-2 items-center">
              ...
              <div className="border-t border-gray-700 p-4 bg-gray-800">
                ...
                >
                  <input
                    ...
                    onChange={(e) => setChatMessage(e.target.value)}
                    placeholder="Ask about nutrition advice..."
                    className="flex-1 border border-gray-600 rounded-lg px-4 py-2 bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    disabled={chatLoading}
                  />
                  <button
                    type="submit"
                    disabled={!chatMessage.trim() || chatLoading}
                    className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:from-gray-600 disabled:to-gray-700"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path>
                    </svg>
