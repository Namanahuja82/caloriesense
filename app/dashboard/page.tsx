...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex-1 pt-24 p-2 sm:p-5">
        <div className={`flex flex-col md:flex-row w-full ${chatOpen && 'h-[calc(100vh-5rem)]'}`}>
          ...
          <div className="w-full max-w-md mx-auto mt-8 bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-4 sm:p-8 space-y-4 sm:space-y-6">
